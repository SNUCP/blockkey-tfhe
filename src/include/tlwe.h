...
struct TLweSampleFFT {
  ...
  TLweSampleFFT(const TLweParams *params, LagrangeHalfCPolynomial *a,
...
EXPORT void init_TLweParams(TLweParams *obj, int32_t N, int32_t k,
                            double alpha_min, double alpha_max);
EXPORT void init_TLweParams_array(int32_t nbelts, TLweParams *obj, int32_t N,
                                  int32_t k, double alpha_min,
                                  double alpha_max);
...
EXPORT TLweParams *new_TLweParams(int32_t N, int32_t k, double alpha_min,
                                  double alpha_max);
EXPORT TLweParams *new_TLweParams_array(int32_t nbelts, int32_t N, int32_t k,
                                        double alpha_min, double alpha_max);
 ...
 * @param params the LWE parameters to use
 */
EXPORT void init_TLweKey_array(int32_t nbelts, TLweKey *ptr,
...
/** finalizes (destructor) an array of TLweKeys (before freeing the memory
 * space)
 * @param nbelts the number of elements to initialize
 * @param ptr the pointer to the first element
 */
...
/** initializes (constructor) an array of TLweSamples on an already allocated
 * space
 * @param nbelts the number of elements to initialize
 * @param ptr the pointer to the first element
 * @param params the LWE parameters to use
 */
EXPORT void init_TLweSample_array(int32_t nbelts, TLweSample *ptr,
                                  const TLweParams *params);
...
/** finalizes (destructor) an array of TLweSamples (before freeing the memory
 * space)
 * @param nbelts the number of elements to initialize
 * @param ptr the pointer to the first element
 */
 ...
 * @param params the LWE parameters to use
 */
EXPORT TLweSample *new_TLweSample_array(int32_t nbelts,
                                        const TLweParams *params);
...
/** initializes (constructor) a single TLweSampleFFT on an already allocated
 * space
 * @param ptr the pointer to the first element
 * @param params the LWE parameters to use
 */
...
/** initializes (constructor) an array of TLweSampleFFTs on an already allocated
 * space
 * @param nbelts the number of elements to initialize
 * @param ptr the pointer to the first element
 * @param params the LWE parameters to use
 */
EXPORT void init_TLweSampleFFT_array(int32_t nbelts, TLweSampleFFT *ptr,
                                     const TLweParams *params);

/** finalizes (destructor) a single TLweSampleFFT (before freeing the memory
 * space)
 * @param ptr the pointer to the first element
 */
EXPORT void destroy_TLweSampleFFT(TLweSampleFFT *ptr);

/** finalizes (destructor) an array of TLweSampleFFTs (before freeing the memory
 * space)
 * @param nbelts the number of elements to initialize
 * @param ptr the pointer to the first element
 */
 ...
 * @param params the LWE parameters to use
 */
EXPORT TLweSampleFFT *new_TLweSampleFFT_array(int32_t nbelts,
                                              const TLweParams *params);
