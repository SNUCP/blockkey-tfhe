...
struct TFheGateBootstrappingParameterSet {
  ...
  TFheGateBootstrappingParameterSet(const int32_t ks_t,
                                    const int32_t ks_basebit,
                                    const LweParams *const in_out_params,
                                    const TGswParams *const tgsw_params);

  TFheGateBootstrappingParameterSet(const int32_t ks_t,
                                    const int32_t ks_basebit, const int32_t hw,
                                    const LweParams *const in_out_params,
                                    const TGswParams *const tgsw_params);

  TFheGateBootstrappingParameterSet(const TFheGateBootstrappingParameterSet &) =
      delete;
...
struct TFheGateBootstrappingCloudKeySet {
  ...
  TFheGateBootstrappingCloudKeySet(const TFheGateBootstrappingCloudKeySet &) =
      delete;
...
struct TFheGateBootstrappingSecretKeySet {
  ...
  TFheGateBootstrappingSecretKeySet(const TFheGateBootstrappingSecretKeySet &) =
      delete;
