...
// result=result+ (X^ai)*bi (ligne 5 de l'algo)
...
/** result = result - sample */
// EXPORT void tGswSubTo(TLweSample* result, const TLweSample* sample, const
// TLweParams* params);
/** result = result + p.sample */
// EXPORT void tGswAddMulTo(TLweSample* result, int32_t p, const TLweSample*
// sample, const TLweParams* params);
/** result = result - p.sample */
// EXPORT void tGswSubMulTo(TLweSample* result, int32_t p, const TLweSample*
// sample, const TLweParams* params);

EXPORT void tGswToFFTConvert(TGswSampleFFT *result, const TGswSample *source,
                             const TGswParams *params);
EXPORT void tGswFromFFTConvert(TGswSample *result, const TGswSampleFFT *source,
                               const TGswParams *params);
...
EXPORT void tfhe_blindRotateAndExtract(LweSample *result,
                                       ...
                                       const TGswSample *bk, const int32_t barb,
                                       const int32_t *bara, const int32_t n,
                                       const TGswParams *bk_params);
EXPORT void tfhe_bootstrap(LweSample *result, const LweBootstrappingKey *bk,
                           Torus32 mu, const LweSample *x);
EXPORT void tfhe_createLweBootstrappingKey(LweBootstrappingKey *bk,
                                           const LweKey *key_in,
                                           const TGswKey *rgsw_key);

EXPORT void tfhe_blindRotate_FFT(TLweSample *accum, const TGswSampleFFT *bk,
                                 const int32_t *bara, const int32_t n,
                                 const TGswParams *bk_params);
...
// const LweKey* key_in, const TGswKey* rgsw_key);
