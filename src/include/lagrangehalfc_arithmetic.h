...
///@file
///@brief This file contains the declaration of operations on LagrangeHalfC
/// polynomials
...
EXPORT void
LagrangeHalfCPolynomialSetTorusConstant(LagrangeHalfCPolynomial *result,
                                        const Torus32 mu);
EXPORT void
LagrangeHalfCPolynomialAddTorusConstant(LagrangeHalfCPolynomial *result,
                                        const Torus32 cst);

EXPORT void
LagrangeHalfCPolynomialSetXaiMinusOne(LagrangeHalfCPolynomial *result,
                                      const int32_t ai);

// /* sets to X^ai-1 */
// This function is commented, because it is not used
// in the current version. However, it may be included in future releases
// EXPORT void LagrangeHalfCPolynomialSetXaiMinusOne(LagrangeHalfCPolynomial*
// result, const int32_t ai);

/** multiplication via direct FFT */
EXPORT void torusPolynomialMultFFT(TorusPolynomial *result,
                                   const IntPolynomial *poly1,
                                   const TorusPolynomial *poly2);
EXPORT void torusPolynomialAddMulRFFT(TorusPolynomial *result,
                                      const IntPolynomial *poly1,
                                      const TorusPolynomial *poly2);
EXPORT void torusPolynomialSubMulRFFT(TorusPolynomial *result,
                                      const IntPolynomial *poly1,
                                      const TorusPolynomial *poly2);
