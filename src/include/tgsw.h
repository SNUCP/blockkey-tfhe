...
struct TGswParams {
  ...
  uint32_t offset; ///< offset = Bg/2 * (2^(32-Bgbit) + 2^(32-2*Bgbit) + ... +
                   ///< 2^(32-l*Bgbit))
...
struct TGswSample {
  ...
  TLweSample *
      *bloc_sample; ///< accès optionnel aux différents blocs de taille l.
  ...
  inline TGswSample(TLweSample *all_sample, TLweSample **bloc_sample,
                    const int32_t k, const int32_t l)
      : all_sample(all_sample), bloc_sample(bloc_sample), k(k), l(l) {}
...
EXPORT void init_TGswKey_array(int32_t nbelts, TGswKey *obj,
...
//(equivalent of the C++ constructor)
EXPORT void init_TGswParams(TGswParams *obj, int32_t l, int32_t Bgbit,
                            const TLweParams *tlwe_params);
EXPORT void init_TGswParams_array(int32_t nbelts, TGswParams *obj, int32_t l,
                                  int32_t Bgbit, const TLweParams *tlwe_params);
...
//(equivalent of the C++ new)
EXPORT TGswParams *new_TGswParams(int32_t l, int32_t Bgbit,
                                  const TLweParams *tlwe_params);
EXPORT TGswParams *new_TGswParams_array(int32_t nbelts, int32_t l,
                                        int32_t Bgbit,
                                        const TLweParams *tlwe_params);
...
EXPORT void init_TGswSample_array(int32_t nbelts, TGswSample *obj,
                                  const TGswParams *params);
...
EXPORT TGswSample *new_TGswSample_array(int32_t nbelts,
                                        const TGswParams *params);
...
EXPORT void init_TGswSampleFFT_array(int32_t nbelts, TGswSampleFFT *obj,
                                     const TGswParams *params);
...
EXPORT TGswSampleFFT *new_TGswSampleFFT_array(int32_t nbelts,
                                              const TGswParams *params);
